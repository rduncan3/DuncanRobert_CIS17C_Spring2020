...
void Score::inPoints(int cat){
    switch (cat){
        case 1:setCat(cat-1,chkVal[0]*1);break;
        case 2:setCat(cat-1,chkVal[1]*2);break;
        case 3:setCat(cat-1,chkVal[2]*3);break;
        case 4:setCat(cat-1,chkVal[3]*4);break;
        case 5:setCat(cat-1,chkVal[4]*5);break;
        case 6:setCat(cat-1,chkVal[5]*6);break;
